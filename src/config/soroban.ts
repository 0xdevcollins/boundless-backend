...
export const PROJECT_FUNDING_CONTRACT_WASM_HASH =
  process.env.PROJECT_FUNDING_CONTRACT_WASM_HASH || "";

// Transaction timeout in seconds
export const TX_TIMEOUT_SECONDS = Number.parseInt(
  process.env.TX_TIMEOUT_SECONDS || "30",
  10,
);

// Maximum transaction retries
export const MAX_TX_RETRIES = Number.parseInt(
  process.env.MAX_TX_RETRIES || "3",
  10,
);
...
// Gas parameters
export const DEFAULT_FEE = Number.parseInt(
  process.env.DEFAULT_FEE || "100",
  10,
);
export const DEFAULT_GAS_BUDGET = Number.parseInt(
  process.env.DEFAULT_GAS_BUDGET || "1000000",
  10,
);
